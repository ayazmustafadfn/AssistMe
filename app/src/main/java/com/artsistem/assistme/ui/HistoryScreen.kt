...
fun HistoryScreen(
    ...
    Scaffold(
        ...
        if (history.isEmpty()) {
            Box(
                ...
                Text(
                    "Henüz tamamlanan hatırlatma yok",
                ...
                items(history, key = { it.id }) { entry ->
                    Card(modifier = Modifier.fillMaxWidth()) {
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Text(
                                text = formatDateTime(entry.completedAtMillis) +
                                    " · " + if (entry.kind == "done") "Tamamlandı" else "Tetiklendi",
    ...
    if (showClearConfirm) {
        AlertDialog(
            ...
            text = { Text("Tüm tamamlananlar geçmişi silinecek. Bu işlem geri alınamaz.") },
            confirmButton = {
                TextButton(onClick = {
